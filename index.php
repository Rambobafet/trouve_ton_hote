...
<html lang="<?php echo $_SESSION['lang']; ?>" ng-app="hebergement">
    <head>
        ...
        <title>Carambal - Trouve un hÃ´te</title>
        ...
        <div class="container theme-showcase">
            ...
            <section  class="col-md-5">
                ...
                <form role="form" name="addHosting" ng-controller="HostingController as hostingCtrl" ng-submit="addHosting.$valid && hostingCtrl.addHost()" class="form-signin" novalidate>
                    ...
                    <label class="sr-only" for="temps_trajet">Temps de trajet estimÃ© jusqu'au bal</label>
                    <input type="text" placeholder="Temps de trajet estimÃ© jusqu'au bal" class="form-control" id="temps_trajet" ng-model="hostingCtrl.host.temps_trajet">

                    <label class="sr-only" for="description">Description des conditions d'hÃ©bergement</label>
                    <textarea name="description" ng-model="hostingCtrl.host.description" required id="description" placeholder="Faites une rapide description des conditions d'accueil, par exemple : J'ai un canapÃ© lit deux places disponibles et je peux fournir les draps" class="form-control"></textarea>

                    <section id="account" ng-controller="TabController as tab" class="ng-scope">
                        <ul class="nav nav-pills">
                            <li ng-class="{ active:tab.isSet(1) }">
                                <a href="" ng-click="tab.setTab(1)">J'ai dÃ©jÃ  un compte</a>
                            </li>
